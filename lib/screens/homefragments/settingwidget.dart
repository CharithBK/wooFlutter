...
class _SettingScreenState extends State<SettingScreen> {
  ...
  Widget getListItem(IconData icon,String title,String extendedTitle,String description,var trailing,Function() callback){
    if(trailing!=null)
      trailing=trailing as IconData;
