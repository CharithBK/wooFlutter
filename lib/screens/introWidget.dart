...
class _IntroScreenState extends State<IntroScreen> {
  ...
  final slides = [
     Slide(
      title: APPNAME,
      styleTitle:
      TextStyle(color: NormalColor, fontSize: 25.0, fontWeight: FontWeight.bold, fontFamily: 'RobotoMono'),
      ...
      styleDescription: TextStyle(color: NormalColor, fontSize: 15.0, fontStyle: FontStyle.italic, fontFamily: 'Raleway'),
      pathImage: "assets/splashone.png",
      backgroundColor: BackgroundColor,
    ),
    Slide(
      title: APPNAME,
      styleTitle: TextStyle(color: NormalColor, fontSize: 25.0, fontWeight: FontWeight.bold, fontFamily: 'RobotoMono'),
  ...
  Widget renderDoneBtn() {
    return Text(
      "Done",
      style: TextStyle(color: NormalColor, fontSize: 18.0 , fontFamily: 'RobotoMono'),
    );
  }
