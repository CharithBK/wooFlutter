...
const AppType APPTYPE = AppType.Dokan;
const AppTheme AppTHEME = AppTheme.main;


final int TabBarCount=(APPTYPE == AppType.WCFM || APPTYPE == AppType.Dokan)?5:4;

final String WOOCOMM_AUTH_USER="ck_id";
final String WOOCOMM_AUTH_PASS="cs_pass";
final String WOOCOMM_URL="https://mundusgaming.com/"; //e.g https://yourwebsitehere.com/
