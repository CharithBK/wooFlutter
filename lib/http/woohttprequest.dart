...
class WooHttpRequest {
  ...
  Future<String> getToken(
      String woocomm_jwt_username, String woocomm_jwt_password) async {
  ...
  Future<GetCustomer?> getCustomer(String email) async {
    ...
    final response = await http.get(
        Uri.parse(WP_JSON_WC + "customers?email=$email$customAppenderAuth"),
        headers: headers);
    if (response.statusCode == 200) {
      print(response.body);
  ...
  Future putNewOrder(BuildContext context, String payment_method,
      String payment_method_title, Map<String, String> shipping_lines) async {
